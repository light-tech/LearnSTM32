...
/* USER CODE BEGIN PV */
uint8_t t[8] = {0, 23, 10, 8, 20, 53, 00, 1};
int v = 0;
/* USER CODE END PV */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, DS1302_RST_Pin|DS1302_DAT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(DS1302_CLK_GPIO_Port, DS1302_CLK_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : DS1302_RST_Pin DS1302_DAT_Pin */
  GPIO_InitStruct.Pin = DS1302_RST_Pin|DS1302_DAT_Pin;
